...
": (do) r> -rot >r >r >r ; "
": do postpone (do) r> 0 >r 0 >r -1 >r here >r >r ; compile-only "
": ?do r> postpone 2dup postpone <> 0 postpone jz, here cell - >r "
"  postpone (do) 0 >r -1 >r here >r >r ; compile-only "
...
": res-loop r> r> r> postpone jz, "
"  r> drop r> begin dup while 1- here r> ! repeat drop "
"  postpone r> postpone r> "
"  r> ?dup if here swap ! then postpone 2drop >r >r ; "
": loop postpone (loop) res-loop ; compile-only "
