...
"< if drop else nip then ; : [ 0 status ! ; immediate : ] 1 status ! ; : ]l "
"] postpone literal ; : compile? status @ ; : , here ! cell allot ; : c, "
"here c! 1 allot ; : cell+ cell + ; : cells cell * ; : 2! tuck ! cell+ ! ; : "
"2@ dup cell+ @ swap @ ; : 2, , , ; : ( begin parsec dup 41 = swap 0= or "
"until ; immediate : \\ begin parsec 0= until ; immediate : (does) last dup "
"funsz cell+ 2* + swap lit! last funsz cell+ + jmp! r> drop ; : does> here "
"funsz cell+ 2* + postpone literal postpone (does) ; immediate compile-only "
...
"over while # repeat ; : (.) d>s <# #s #> ; : . (.) type space ; : .r swap "
"(.) rot over - spaces type ; : .s .\" stack(\" depth (.) type .\" ): \" "
...
"-rot >r >r swap >r ; compile-only create cs 32 allot 0 value cso : >cs cs "
"cso + c! cso 1+ %11111 and to cso ; : cs> cs cso 1- %11111 and dup to cso + "
"c@ ; : case 0 >cs ; immediate compile-only : of postpone over postpone = r> "
